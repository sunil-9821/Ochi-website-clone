...
function Footer() {
  return (
    <motion.div>
      <div className="w-full min-h-screen flex gap-5 p-16 text-zinc-800 ">
        <div className="w-1/2 uppercase text-[7vw] leading-[7vw] -tracking-widest font-bold">
          <h1>Eye-</h1>
          <h1>opening</h1>
        </div>
        <div className="w-1/2">
          <h1 className="uppercase text-[7vw] leading-[7vw] -tracking-widest font-bold">
            presentations
          </h1>
          ...
          <div className="flex justify-between mt-10 text-[1.5vw]">
            <div>
              L: <br />
              <br />
              <u>
              ...
              <br />
              <br /> <u>E: hello@ochi.design</u>
            </div>
            <div>
              M: <br /> <u>Home</u> <br /> <u>Services</u> <br />{" "}
              <u>Our work</u>
              <br />
              <u> About us</u> <br /> <u>Insights </u>
              <br /> <u>Contact us</u>
            </div>
          </div>
        </div>
      </div>
      <div className="w-full flex items-center justify-between py-10 px-12">
        ...
        <p className="text-zinc-400">© ochi design 2024. Legal Terms</p>
        <p className="text-zinc-400">Website by Obys</p>
      </div>
    </motion.div>
  );
}
