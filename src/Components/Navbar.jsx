...
function Navbar() {
  return (
    <div className="fixed z-[999] w-full backdrop-blur-sm px-10 py-4 flex justify-between font-sans">
      <div className="logo">
      ...
      <div className="links flex gap-4">
        {["Service", "Our work", "About us", "Insights", "contact us"].map(
          (link, i) => {
            return (
              <a
                href="#"
                key={i}
                className={`text-lg capitalize ${i === 4 && "ml-52"}`}
              >
                {link}
              </a>
            );
