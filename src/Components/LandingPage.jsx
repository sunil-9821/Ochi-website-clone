...
function LandingPage() {
  return (
    <div
      ...
      data-scroll-section
      data-scroll-speed="-.3"
      className=" h-screen w-full pt-1 font-serif"
    >
      <div className=" relative">
        <div className="textsturcture mt-40 px-12">
                ...
                <div className="w-fit flex items-center">
                  {i === 1 && (
                    <motion.div
                      ...
                      className="h-24 rounded-xl w-[10vw] bg-red-500"
                    ></motion.div>
                  )}
                  <h1 className="uppercase text-[8vw] font-semibold -tracking-widest leading-[6.5vw]">
                    {item}
                  </h1>
                </div>
              </div>
        ...
        <div className="scale-50 origin-top-right md:scale-100 absolute top-5 lg:top-150 right-0">
      ...
      <div className="border-t-[1px] border-zinc-500 mt-24 flex justify-between px-10 py-6  font-sans">
        {[
        ...
        <div className="flex items-center gap-3 cursor-pointer group">
          <button className="border-2 border-zinc-200 px-3 py-1 text-lg rounded-full">
            Start the project
          </button>
          <div className="h-9 w-9 rounded-full border-2 border-zinc-200 flex items-center justify-center rotate-45">
